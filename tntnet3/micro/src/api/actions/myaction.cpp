...
log_define("component.src.api.actions.myaction")
...
static tnt::EcppComponentFactoryImpl<_component_> Factory("src/api/actions/myaction");
...
{
  log_trace("src/api/actions/myaction " << qparam.getUrl());
...
#line 6 "./src/action.ecpp"
  ...
  // </%include>
#line 2 "src/api/actions/myaction.ecpp"
